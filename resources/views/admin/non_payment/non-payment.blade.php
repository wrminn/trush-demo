                ...
                <table class="table table-bordered table-striped dataTable no-footer" id="data_table"
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>0812345678</td>
                            <td>500 บาท</td>
                            <td><span class="text-danger">ยังไม่ชำระ 2 รายการ</span></td>
                            <td><a href="/admin/non_payment/detail" class="btn btn-primary btn-sm">ดูบิล</a></td>
                        </tr>
                        <tr>
                            <td>456/78</td>
                            <td>-</td>
                            <td>300 บาท</td>
                            <td><span class="text-danger">ยังไม่ชำระ 1 รายการ</span></td>
                            <td><a href="/admin/non_payment/detail" class="btn btn-primary btn-sm">ดูบิล</a></td>
                        </tr>
                    </tbody>
                </table>
