...
<body class="d-flex bg-body-secondary">
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-white p-3" style="width: 250px; height: 100vh;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="#"
                    class="nav-link {{ Request::is('admin/showdata') ? 'active' : '' }}">ข้อมูลฟอร์มที่ส่งเข้ามา</a>
            </li>
            <li>
                <a href="/admin/trash_can_installation"
                    class="nav-link {{ Request::is('admin/trash_can_installation') ? 'active' : '' }}">ตำแหน่งที่ติดตั้งถังขยะ</a>
            </li>
            <li>
                <a href="/admin/trash_installer"
                    class="nav-link {{ Request::is('admin/trash_installer') ? 'active' : '' }}">ผู้ใช้บริการติดตั้งถังขยะ</a>
            </li>
            <li>
                <span>Report</span>
            </li>
